...
import styles from "@App/components/atoms/PastInterviewTable/PastInterviewTableHeader.module.scss"
...
export default function PastInterviewTableHeader(props: Props ){
